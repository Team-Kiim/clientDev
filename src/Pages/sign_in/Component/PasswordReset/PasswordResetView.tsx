        ...
        <div className={'flex flex-col gap-y-10'}>
            <div className={'flex flex-col items-center gap-y-4'}>
                <div className={'rounded-full bg-violet-100 p-1'}>
                    <MdLockReset className={'size-8 text-violet-600'} />
                </div>
            ...
            <form className={'flex w-full flex-col items-center gap-y-5'} onSubmit={handleSubmit(onSubmit)}>
                ...
                <button
                    className={
                        'rounded-xl bg-violet-600 px-10 py-3 text-[0.9rem] font-bold text-white transition-all hover:bg-violet-700'
                    }
                >
                    메일로 전송
                </button>

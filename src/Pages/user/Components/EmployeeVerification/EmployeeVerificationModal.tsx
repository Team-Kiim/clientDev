...
import RequestToAddDomainView from '@/Pages/user/Components/EmployeeVerification/RequestToAddDomain/RequestToAddDomainView.tsx';
    ...
    return (
        <Modal
            ...
            onAfterClose={() => {
                ...
                setCurrentViewName('employeeVerificationView');
            }}
        >
            {currentViewName === 'employeeVerificationView' ? (
                <>
                    ...
                    <div className={'flex flex-col gap-y-8'}>
                        ...
                        <div className={'flex justify-end'}>
                            <p className={'text-[0.75rem] text-slate-500'}>
                                ...
                                <button
                                    className={
                                        'font-bold text-plump-purple-600 hover:underline hover:underline-offset-4'
                                    }
                                    type={'button'}
                                    onClick={() => {

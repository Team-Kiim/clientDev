...
export default function ChatRoomListItem({
    ...
    const svgSrc = `/assets/svgs/skillCategory/${parentSkillCategory}/${childSkillCategory.toLowerCase()}.svg`;
            ...
            <Link to={`/chat/${chatRoomId}`}>
                <div className={'flex flex-col gap-y-4 transition-all'}>
                    <div className={'flex items-center gap-x-3'}>
                        <img className={'size-10 object-contain'} src={svgSrc} alt={'js'} />
                        <div className={'flex flex-col'}>
                            <h2 className={'text-[1.1rem] font-extrabold text-slate-800'}>{childSkillCategoryLabel}</h2>
                            <div className={'w-fit rounded-lg bg-plump-purple-50 px-1 py-0.5'}>

...
const getPostList: QueryFunction<
    Post[],
    [_1: string, _3: { postType: string; title: string; keywords: string[]; currentPage }]
> = ({ queryKey }) => {
    const { postType, title, keywords, currentPage } = queryKey[1];
    console.log(postType, title, keywords, currentPage);
